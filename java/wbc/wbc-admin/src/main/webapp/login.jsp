										...
										<form id="loginform" name="loginform"
											...
											<fieldset>
												...
												<span class="block input-icon input-icon-right">
													<input name="accountName" id="accountName" type="hidden" class="form-control"/> 
													<input name="mobile" id="mobile" type="hidden" class="form-control"/> 
													<input name="loginName" id="loginName" type="email" class="form-control" placeholder="邮箱或手机号登录" /> 
