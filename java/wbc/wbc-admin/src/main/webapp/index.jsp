			...
			<div class="navbar-buttons navbar-header pull-right" role="navigation">
				<ul class="nav ace-nav">
					<li class="green"><a data-toggle="dropdown"
						...
						<ul
							...
							<li class="dropdown-header"><i
								class="ace-icon fa fa-envelope-o"></i> 0条通知</li>
							...
							<li class="dropdown-content">
								<ul class="dropdown-menu dropdown-navbar">
									<li><a href="#">
											<div class="clearfix">
												<span class="pull-left"> <i
													...
													系统消息
												</span> <span class="pull-right badge badge-info">+0</span>
											</div>
									</a></li>
									...
									<li><a href="#">
											<div class="clearfix">
												<span class="pull-left"> <i
													...
													管理员消息
												</span> <span class="pull-right badge badge-success">+0</span>
											</div>
									</a></li>
									...
									<li><a href="#">
											<div class="clearfix">
												<span class="pull-left"> <i
													class="btn btn-xs no-hover btn-primary fa fa-twitter"></i>
													其他消息
												</span> <span class="pull-right badge badge-info">+0</span>
											</div>
									</a></li>
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <%-- <img class="nav-user-photo" src="${not empty userEntity.getPhoto_32x32()}" alt="头像" style="width:40px;height:40px;"/> --%>
							<c:if test="${!empty userEntity && !empty userEntity.photo}">
								<img class="nav-user-photo" src="${userEntity.getPhoto_35()}"
						...
						<ul
							...
							<li><a href="javascript:void(0)"
								nav-menu="修改密码,/user/passwordUI.html?id=${userEntity.id }&mobile=${userEntity.mobile}&nickName=${userEntity.nickName}">
									<i class="ace-icon fa fa-cog"></i> 修改密码
							</a></li>
							<li><a href="javascript:void(0)"
								nav-menu="修改头像,/user/avatarUI.html?id=${userEntity.id }"> <i
									class="ace-icon fa fa-github"></i> 修改头像
							</a></li>
							<li><a href="javascript:void(0)"
