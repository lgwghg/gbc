...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/customer/business/system/sw/list.js"></script>

<div class="page-header">
	<shiro:hasPermission name="sw:add">
		<button id="btnAdd" type="button" onclick="webside.common.addModel('/system/sw/addUI.html')" class="btn btn-primary btn-sm">
...
<div class="input-group" >
	<label class="search">内容：<input id="content" type="text" placeholder="内容"></label>
	<label class="search">所属类型：
   		<select id="contentType" style="width: 170px;">
   	...
   	<label class="search">作用域类型：
   		<select id="useType" style="width: 170px;">
   			<option value="">不限</option>
	...
	<div class="col-xs-12 widget-container-col ui-sortable" style="min-height: 127px;">
		...
		<div class="widget-box transparent ui-sortable-handle" style="opacity: 1; z-index: 0;">
			<div class="widget-header">
				<h4 class="widget-title lighter">敏感词列表</h4>
