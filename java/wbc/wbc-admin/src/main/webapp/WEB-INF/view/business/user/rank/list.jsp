...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/customer/jcrank/list.js"></script>

<div class="page-header">
	<shiro:hasPermission name="jcRank:add">
		<button id="btnAdd" type="button" onclick="webside.common.addModel('/jcRank/addUI.html')" class="btn btn-primary btn-sm">
		  	<i class="fa fa-user-plus"></i>&nbsp;添加
		</button>
	</shiro:hasPermission>
	<shiro:hasPermission name="jcRank:edit">
		<button id="btnEdit" type="button" onclick="webside.common.editModel('/jcRank/editUI.html')" class="btn btn-success btn-sm">
