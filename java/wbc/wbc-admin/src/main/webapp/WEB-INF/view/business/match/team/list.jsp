...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/customer/business/match/team/list.js"></script>

<div class="page-header">
	<shiro:hasPermission name="team:add">
		<button id="btnAdd" type="button" onclick="webside.common.addModel('/match/team/addUI.html')" class="btn btn-primary btn-sm">
...
<div class="input-group" >
	<label class="search">战队名称：<input id="teamName" type="text" placeholder="战队名称"></label>
	...
	<label class="search">战队状态：
   		<select id="teamStatus" style="width: 170px;">
	...
	<div class="col-xs-12 widget-container-col ui-sortable" style="min-height: 127px;">
		...
		<div class="widget-box transparent ui-sortable-handle" style="opacity: 1; z-index: 0;">
			<div class="widget-header">
				<h4 class="widget-title lighter">战队列表</h4>
