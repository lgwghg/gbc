...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/customer/business/system/sc/list.js"></script>

<div class="page-header">
	<shiro:hasPermission name="sc:add">
		<button id="btnAdd" type="button" onclick="webside.common.addModel('/system/sc/addUI.html')" class="btn btn-primary btn-sm">
