...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/customer/business/system/sn/webNoticeList.js"></script>

<div class="page-header">
	<shiro:hasPermission name="webSN:add">
		<button id="btnAdd" type="button" onclick="webside.common.addModel('/system/webNotice/addUI.html')" class="btn btn-primary btn-sm">
...
<div class="input-group" >
   	...
   	<label class="search">编码：<input id="code" type="text" placeholder="编码"></label>
   	<label class="search">内容：<input id="content" type="text" placeholder="内容"></label>
	<label class="search">类型：
   		<select id="type" style="width: 170px;">
