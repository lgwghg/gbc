...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/customer/business/match/game/list.js"></script>

<div class="page-header">
	<shiro:hasPermission name="game:add">
		<button id="btnAdd" type="button" onclick="webside.common.addModel('/match/game/addUI.html')" class="btn btn-primary btn-sm">
...
<div class="input-group" >
	<label class="search">游戏名称：<input id="gameName" type="text" placeholder="游戏名称"></label>
   	<label class="search">英文简称：<input id="englishName" type="text" placeholder="英文简称"></label>
	...
	<label class="search">游戏状态：
   		<select id="gameStatus" style="width: 170px;">
