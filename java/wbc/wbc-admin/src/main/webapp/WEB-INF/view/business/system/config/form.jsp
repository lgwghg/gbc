...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/customer/config/form.js"></script>
...
<div class="center">
	...
	<button id="btn" type="button" onclick="webside.common.loadPage('/config/listUI<c:if test="${!empty entity}">?page=${page.pageNum}&rows=${page.pageSize}&sidx=${page.orderByColumn}&sord=${page.orderByType}</c:if>')" class="btn btn-info btn-sm">
