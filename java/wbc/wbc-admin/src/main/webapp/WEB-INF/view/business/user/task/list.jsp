...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/customer/user/task/list.js"></script>

<div class="page-header">
	<shiro:hasPermission name="task:add">
		<button id="btnAdd" type="button" onclick="webside.common.addModel('/task/addUI')" class="btn btn-primary btn-sm">
		  	<i class="fa fa-user-plus"></i>&nbsp;添加
		</button>
	</shiro:hasPermission>
	<shiro:hasPermission name="task:edit">
		<button id="btnEdit" type="button" onclick="webside.common.editModel('/task/editUI')" class="btn btn-success btn-sm">
