...
<head>
	...
	<title>404${seoConfigMap['1'].title }</title>
...
<body>
	...
	<div class="serviceError404">
    	<img src="${staticPrefix }/images/404.png">
    	<div class="return404"><a href="${ctx }/index"><img src="${staticPrefix }/images/return.png"</a></div>
    </div>
