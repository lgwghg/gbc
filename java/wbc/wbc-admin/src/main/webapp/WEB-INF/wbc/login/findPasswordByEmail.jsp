...
<c:set var="staticPrefix"
	value="${pageContext.request.contextPath}/resources/wodota" />
<%
...
<head>
	...
	<title>邮箱找回密码${seoConfigMap['1'].title }</title>
...
<div class="main">
      ...
      <form role="form" class="mt-15" id="findPasswordForm" name="findPasswordForm" action="${ctx }/fp/findPasswordByEmail/" method="post">
            <div class="form-group">
                <!-- form-item -->
                <div class="form-item form_item mt-10">
                        <div class="item-tip">输入邮箱</div>
                        <input class="form-input" name="email" id="email" tabindex="1" type="text" style="width:100%; margin-top:5px; height:45px;">
               ...
               <!-- form-item -->
                <div class="form-item form_item" style="width:250px;margin: 15px 0;">
                    <div class="item-tip">验证码</div>
                     <input class="form-input v320" name="captcha" id="captcha" tabindex="1" type="text" style=" margin-top:5px; height:45px;width:93%;" onKeyup="checkEmailCaptcha(0)">
             		<span class="error" id="captchaError"></span>
                    <button type="button" class="btn btn-primary vsend send-auth-code" style="position: absolute;right: -110px;top: 4.5px; height:42px;width:110px;" disabled=true>发送验证码
                    </button>
                </div>
            </div>
		...
		<button type="button" class="btn btn-primary btn-block  h38 fn_16" style="margin-top:20px; height:45px;" onclick="submitCheckEmail()" disabled=true id="submitCheckEmail">提 交</button>
