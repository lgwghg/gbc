        ...
        <div class="roll-coins-history">
        	<div class="message-details-outside">
	        	<div class="my-message">
	                <ul class="bottom">
	                    <li>
	                        <span class="view1">游戏次数：</span>
	                        <span class="view2" id="gameCount"></span>
	                    </li>
	                    <li>
	                        <span class="view1">游戏总量：</span>
	                        <span class="view2" id="goldNumSum"></span>
	                    </li>
	                    <li>
	                        <span class="view1">总胜利率：</span>
	                        <span class="view2" id="probability"></span>
	                    </li>
	                    <li>
	                        <span class="view1">积分总量：</span>
	                        <span class="view2" id="winnerGoldNumSum"></span>
	                    </li>
	                    <li>
	                        <span class="view1">日游戏次数：</span>
	                        <span class="view2" id="todayGameCount"></span>
	                    </li>
	                    <li>
	                        <span class="view1">日游戏总量：</span>
	                        <span class="view2" id="todayGoldNumSum"></span>
	                    </li>
	                    <li>
	                        <span class="view1">日胜利率：</span>
	                        <span class="view2" id="todayProbability"></span>
	                    </li>
	                    <li>
	                        <span class="view1">日积分总量：</span>
	                        <span class="view2" id="todayWinnerGoldNumSum"></span>
	                    </li>
	                </ul>
	            </div>
...
<script>
    $.material.init();
    $(function(){
    	loadHistoryList(_path + "/coinflip/u/historyData");
        myData();
    })
</script>
</html>
