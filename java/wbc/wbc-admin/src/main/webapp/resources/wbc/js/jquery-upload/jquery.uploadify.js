(function($){
	$.fn.Huploadify = function(opts){
		var itemTemp = '<div id="${fileID}" style="display:none;" class="uploadify-queue-item"><div class="uploadify-progress"><div class="uploadify-progress-bar"></div></div><span class="up_filename">${fileName}</span><a href="javascript:void(0);" class="uploadbtn">上传</a><a href="javascript:void(0);" class="delfilebtn">删除</a></div>';
		var defaults = {
				...
				init : function(){
					...
					returnObj =  {
						...
						disable : function(instanceID){
							...
							parent.find('.btn-primary').css('background-color','#888').off('click');
						},
						ennable : function(instanceID){
							//点击上传按钮时触发file的click事件
							var parent = instanceID ? $('file_upload_'+instanceID+'-button') : $('body');
						  	parent.find('.btn-primary').css('background-color','#707070').on('click',function(){
					...
					_this.find('.btn-primary').on('click',function(){
