...
(function() {
    ...
    s.removeChild = function(a) {
        ...
        if (a && this.P) {
            ...
            c && (this.Pa[a.id] = k,
                this.Qa[a.name] = k,
            (c = a.w()) && c.parentNode === this.ja() && this.ja().removeChild(a.w()))
        }
    }
    ;
    s.wc = function() {
    ...
    t.D.rd = {
        1: "您中止了视频播放.",
        2: "网络错误导致视频下载失败,请检查您的网络.",
        3: "视频播放失败,或许是因为您的浏览器不支持该格式视频.",
        4: "视频无法加载,有可能是因为服务器或网络故障或者因为不支持的视频格式。",
        5: "视频被加密，我们没有对其进行解密的密钥。"
    };
        ...
        if (a.hasChildNodes()) {
            ...
            for (h = a.length; g < h; g++)
                c = a[g],
                    ...
                    "source" === d ? e.sources.push(t.Aa(c)) : "track" === d && e.tracks.push(t.Aa(c))
        }
        return e
    }
    s.e = function() {
    ...
    function Q(a, c, d) {
        ...
        d && (a.nc = d.type,
        d.src == a.G.src && 0 < a.G.currentTime && (e.startTime = a.G.currentTime),
            a.G.src = d.src);
    ...
    s.vc = l;
    function R(a, c) {
        c !== b && a.vc !== c && ((a.vc = c) ? (a.n("vjs-has-started"),
    ...
    ;
    s.Ld = function() {
        this.m.loop ? (this.currentTime(0),
    ...
    s.currentTime = function(a) {
        return a !== b ? (T(this, "setCurrentTime", a),
            this) : this.G.currentTime = S(this, "currentTime") || 0
    }
    ;
    s.duration = function(a) {
        if (a !== b)
            return this.G.duration = parseFloat(a),
                this;
    ...
    s.exitFullscreen = function() {
        ...
        if (a)
            ...
            this.o.Ea() ? T(this, "exitFullScreen") : (this.Cb(),
                this.l("fullscreenchange"));
        return this
    }
    ;
    ...
    ;
    s.Da = function(a) {
        return a !== b ? (T(this, "setPreload", a),
            this.m.preload = a,
            this) : S(this, "preload")
    }
    ;
    s.autoplay = function(a) {
        return a !== b ? (T(this, "setAutoplay", a),
            this.m.autoplay = a,
            this) : S(this, "autoplay")
    }
    ;
    s.loop = function(a) {
        return a !== b ? (T(this, "setLoop", a),
            this.m.loop = a,
            this) : S(this, "loop")
    }
    ;
    ...
    s.usingNativeControls = function(a) {
        return a !== b ? (a = !!a,
        this.Tb !== a && ((this.Tb = a) ? (this.n("vjs-using-native-controls"),
    ...
    s.playbackRate = function(a) {
        return a !== b ? (T(this, "setPlaybackRate", a),
            this) : this.o && this.o.featuresPlaybackRate ? S(this, "playbackRate") : 1
    }
    ;
    s.xc = l;
    function P(a, c) {
    ...
    t.Ka.prototype.s = function() {
        this.d.isFullscreen() ? (this.d.exitFullscreen(),
            this.xb.innerHTML = this.t("Fullscreen")) : (this.d.requestFullscreen(),
    ...
    t.ia.prototype.e = function() {
    	var mid = this.L.substring(0,this.L.lastIndexOf('_'));
    	mid = "mute_"+mid.substring(0,mid.lastIndexOf('_'));
    ...
    t.ra.prototype.e = function() {
        ...
        t.Wc || (this.Db = t.e("img"),
            a.appendChild(this.Db));
        return a
    }
    ;
    t.ra.prototype.update = function() {
        var a = this.k().poster(), c;
        this.Db ? this.Db.src = a : (c = "",
        a && (c = 'url("' + a + '")'),
    ...
    t.q = t.a.extend({
        i: function(a, c, d) {
            ...
            c.Jc = l;
            t.a.call(this, a, c, d);
            this.featuresProgressEvents || (this.Bc = f,
                this.Gc = setInterval(t.bind(this, function() {
                    var a = this.k().bufferedPercent();
                    this.ld != a && this.k().l("progress");
                    this.ld = a;
                    1 === a && clearInterval(this.Gc)
                }), 500));
            this.featuresTimeupdateEvents || (a = this.d,
                this.Lb = f,
                this.c(a, "play", this.Rc),
                this.c(a, "pause", this.cb),
                this.R("timeupdate", function() {
    ...
    t.h = t.q.extend({
        i: function(a, c, d) {
            ...
            a.K(function() {
                this.I && (this.m.autoplay && this.paused()) && (delete this.I.poster,
                    this.play())
            });
            this.Ga()
        }
    ...
    s.pc = function() {
        ...
        a.paused && a.networkState <= a.ne ? (this.b.play(),
            setTimeout(function() {
                a.pause();
    ...
    t.h.Dc = function() {
        4 <= t.Ub && (V || (V = t.A.constructor.prototype.canPlayType),
                t.A.constructor.prototype.canPlayType = function(a) {
                    return a && ga.test(a) ? "maybe" : V.call(this, a)
                }
        );
        t.dd && (V || (V = t.A.constructor.prototype.canPlayType),
                t.A.constructor.prototype.canPlayType = function(a) {
    ...
    t.f = t.q.extend({
        i: function(a, c, d) {
            ...
            e && (e.type && t.f.Gd(e.type) ? (e = t.f.Pc(e.src),
    ...
    function na(a) {
        0 === a.na && a.load();
        0 === a.ma && (a.d.c("timeupdate", t.bind(a, a.update, a.L)),
            a.d.c("ended", t.bind(a, a.reset, a.L)),
        ("captions" === a.H || "subtitles" === a.H) && a.d.ka("textTrackDisplay").V(a))
    }
    s.load = function() {
        0 === this.na && (this.na = 1,
            t.get(this.Mc, t.bind(this, this.Wd), t.bind(this, this.Md)))
    }
    ;
    s.Md = function(a) {
        this.error = a;
    ...
    s.update = function() {
        if (0 < this.ca.length) {
            ...
            if (this.Pb === b || a < this.Pb || this.Wa <= a) {
                ...
                a >= this.Wa || this.Wa === b ? w = this.Eb !== b ? this.Eb : 0 : (g = f,
                    w = this.Kb !== b ? this.Kb : c.length - 1);
                for (; ; ) {
                    r = c[w];
                    if (r.ya <= a)
                        e = Math.max(e, r.ya),
    ...
    s.xa = function() {
        for (var a = this.d.textTracks(), c = 0, d = a.length, e, g, h = this.Q = []; c < d; c++)
            if (e = a[c],
                ...
                if (0 === e.readyState())
                    e.load(),
                        e.c("loaded", t.bind(this, this.xa));
                else {
                    g = e;
                    break
                }
        a = this.Ba;
        a === b && (a = new t.ha(this.d),
        ...
        t.JSON.parse = function(a, c) {
            function d(a, e) {
                ...
                if (r && "object" === typeof r)
                    for (j in r)
                        Object.prototype.hasOwnProperty.call(r, j) && (n = d(r, j),
