function fullAvatarEditor() {
	...
	var file			= sys.rootPath + '/resources/js/fullavatar/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= sys.rootPath + '/resources/js/fullavatar/expressInstall.swf';		//expressInstall.swf的路径
