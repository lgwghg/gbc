...
public class AlipayNotify {
	...
	public static boolean verify(Map<String, String> params) {
	    ...
	    boolean isSign = getSignVeryfy(params, sign,AlipayConfig.SignType.MD5);
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign,String signType) {
        ...
        if(signType.equals(AlipayConfig.SignType.MD5) ) {
        	isSign = MD5.verify(preSignStr, sign, AlipayConfig.Key.MD5_KEY, AlipayConfig.InputCharset.UTF8);
        }
        return isSign;
    }
